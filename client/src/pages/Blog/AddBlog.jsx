...
const AddBlog = () => {
    ...
    const handleGenerateContent = async () => {
        ...
        if (!title || !category) {
            showToast('error', 'Please enter a title and select a category first')
            return
        }

        setIsGenerating(true)
        try {
            const response = await fetch(`${getEvn('VITE_API_BASE_URL')}/blog/generate-content`, {
                method: 'POST',
                headers: {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Editor props={{ initialData: editorContent, onChange: handleEditorData }} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
